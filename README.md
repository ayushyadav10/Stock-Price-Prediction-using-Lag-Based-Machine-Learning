...
```bash
git clone <[(https://github.com/ayushyadav10/Stock-Price-Prediction-using-Lag-Based-Machine-Learning)](https://github.com/ayushyadav10/Stock-Price-Prediction-using-Lag-Based-Machine-Learning.git)>
